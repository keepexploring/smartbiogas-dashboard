...
describe('PaginationControlsComponent:', () => {
  ...
  it(
    'should display the correct page links (simple)',
    fakeAsync(() => {
  ...
  it(
    'should display the correct page links (end ellipsis)',
    fakeAsync(() => {
      let fixture = TestBed.createComponent(ComponentTestComponent);
      let instance = fixture.componentInstance;
  ...
  it(
    'should display the correct page links (start ellipsis)',
    fakeAsync(() => {
      let fixture = TestBed.createComponent(ComponentTestComponent);
  ...
  it(
    'should display the correct page links (double ellipsis)',
    fakeAsync(() => {
      let fixture = TestBed.createComponent(ComponentTestComponent);
      let instance: ComponentTestComponent = fixture.componentInstance;
  ...
  it(
    'should update links when collection size changes',
    fakeAsync(() => {
      let fixture = TestBed.createComponent(ComponentTestComponent);
      let instance: ComponentTestComponent = fixture.componentInstance;
      let expected = ['1', '2', '3', '4', '5', '6', '7', '...', '10'];
  ...
  it(
    'should update the currently-active page when currentPage changes',
    fakeAsync(() => {
      let fixture = TestBed.createComponent(ComponentTestComponent);
      let instance: ComponentTestComponent = fixture.componentInstance;
  ...
  it(
    'should highlight the currently-active page when currentPage is passed as a numeric string',
    fakeAsync(() => {
      let fixture = TestBed.createComponent(ComponentTestComponent);
      let instance: ComponentTestComponent = fixture.componentInstance;
  ...
  it(
    'should update the currently-active page when currentPage becomes invalid (too high)',
    fakeAsync(() => {
      let fixture = TestBed.createComponent(ComponentTestComponent);
      let instance: ComponentTestComponent = fixture.componentInstance;
      let controlsDirective = getControlsDirective(fixture);
  ...
  it('should allow multiple independent instances (controller test)', () => {
    ...
    let controls: PaginationControlsDirective[] = fixture.debugElement
      .queryAll(By.css('pagination-template'))
  ...
  it(
    'should allow multiple independent instances (template test)',
    fakeAsync(() => {
      overrideTemplate(
        ComponentTestComponent,
        `
      ...
      let controlsDirectives: PaginationControlsDirective[] = controls.map(
        el => el.references['p'],
      );
  ...
  it('"autoHide" should be boolean', () => {
    let fixture = TestBed.createComponent(ComponentTestComponent);
    let controlsInstance = fixture.debugElement.query(By.css('pagination-controls'))
      .componentInstance;
  ...
  it('"autoHide" should work with non-data-bound values', () => {
    ...
    let fixture = TestBed.createComponent(ComponentTestComponent);
    fixture.detectChanges();
    const controlsCmp: PaginationControlsComponent = fixture.debugElement.query(
  ...
  it(
    '"directionLinks" state should be reflected in default template',
    fakeAsync(() => {
      let fixture = TestBed.createComponent(ComponentTestComponent);
      fixture.detectChanges();
  ...
  describe('custom labels', () => {
    ...
    it(
      'previousLabel should bind in correct locations',
      fakeAsync(() => {
        overrideTemplate(
          ComponentTestComponent,
          `
        ...
        let prevSpan = fixture.debugElement.query(By.css('.pagination-previous > span'))
          .nativeElement;
    ...
    it(
      'nextLabel should bind in correct locations',
      fakeAsync(() => {
        overrideTemplate(
          ComponentTestComponent,
          `
    ...
    it(
      'screenReaderPaginationLabel should bind in correct locations',
      fakeAsync(() => {
        overrideTemplate(
          ComponentTestComponent,
          `
    ...
    it(
      'screenReaderPageLabel should bind in correct locations',
      fakeAsync(() => {
        overrideTemplate(
          ComponentTestComponent,
          `
        ...
        let pageA = fixture.debugElement.queryAll(By.css('.ngx-pagination li > a'))[1]
          .nativeElement;
    ...
    it(
      'screenReaderCurrentLabel should bind in correct locations',
      fakeAsync(() => {
        overrideTemplate(
          ComponentTestComponent,
          `
        ...
        let currentPage = fixture.debugElement.query(
          By.css('.ngx-pagination li.current .show-for-sr'),
        ).nativeElement;
