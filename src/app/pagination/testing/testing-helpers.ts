...
import { PaginationInstance } from '../pagination.module';
 ...
 */
export function getControlsDirective(
  fixture: ComponentFixture<ComponentTestComponent>,
...
export function getPageLinkItems(
  ...
  if (includeAll) {
    ...
    return all.filter(str => str.match(/\d+|\.\.\./)).map(str => str.match(/\d+|\.\.\./)[0]);
  }
}
