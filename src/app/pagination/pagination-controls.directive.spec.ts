...
describe('PaginationControlsDirective:', () => {
  ...
  it(
    'should warn on interaction when an unknown id is used',
    fakeAsync(() => {
      overrideTemplate(
      ...
      expect(warnSpy).toHaveBeenCalledWith(
        'PaginationControlsDirective: the specified id "unknown_id" does not match any registered PaginationInstance',
      );
  ...
  describe('template api', () => {
    function getControlsDirective(
      ...
      let controlsDirective: PaginationControlsDirective = fixture.debugElement.query(
        By.css('pagination-template'),
      ).references['p'];
      fixture.detectChanges();
    ...
    it(
      '"setCurrent()" should emit pageChange event with correct value',
      fakeAsync(() => {
        let fixture = TestBed.createComponent(DirectiveTestComponent);
        let testCmpInstance = fixture.componentInstance;
        let controlsDirective = getControlsDirective(fixture);
    ...
    it(
      '"previous()" should emit pageChange event with correct value',
      fakeAsync(() => {
        let fixture = TestBed.createComponent(DirectiveTestComponent);
        let testCmpInstance = fixture.componentInstance;
        let controlsDirective = getControlsDirective(fixture);
    ...
    it(
      '"next()" should emit pageChange event with correct value',
      fakeAsync(() => {
        let fixture = TestBed.createComponent(DirectiveTestComponent);
        let testCmpInstance = fixture.componentInstance;
        let controlsDirective = getControlsDirective(fixture);
    ...
    it(
      '"isFirstPage()" should return the correct value',
      fakeAsync(() => {
        let fixture = TestBed.createComponent(DirectiveTestComponent);
        let testCmpInstance = fixture.componentInstance;
        let controlsDirective = getControlsDirective(fixture);
    ...
    it(
      '"isLastPage()" should return the correct value',
      fakeAsync(() => {
        let fixture = TestBed.createComponent(DirectiveTestComponent);
        let testCmpInstance = fixture.componentInstance;
        let controlsDirective = getControlsDirective(fixture);
